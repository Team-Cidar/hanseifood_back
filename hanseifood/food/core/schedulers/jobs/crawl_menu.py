...
def get_and_save_menus():
    try:
        ...
        data.students = {
            '2023-11-20': ['바지락살미역국', '제육김치볶음', '맛살계란찜', '콩나물무침', '깍두기'],
            '2023-11-21': ['우삼겹된장찌개', '해물완자전*케찹', '실곤약야채무침', '요쿠르트', '배추김치'],
            '2023-11-22': ['유부우동국', '새우튀김날치알마요덮밥', '김말이떡강정', '숙주나물무침', '배추김치'],
            '2023-11-23': ['두부새우젓국', '짜장불고기', '청경채볶음우동', '근대된장나물', '배추김치'],
            '2023-11-24': ['유부잔치국수', '김치메밀전병', '탕평채', '단무지무침', '배추김치']
        }
        data.employees = {
            '2023-11-20': ['바지락살미역국', '제육김치볶음', '맛살계란찜', '시금치나물', '백김치/요구르트'],
            '2023-11-21': ['우삼겹된장찌개', '해물완자전*케찹', '실곤약야채무침', '연근조림', '포기김치/도시락김'],
            '2023-11-22': ['돈육비지찌개', '가자미구이', '김말이떡강정', '들깨호박나물', '깍두기/숙주나물무침'],
            '2023-11-23': ['두부새우젓국', '짜장불고기', '청경채볶음우동', '도라지오이무침', '포기김치/근대된장나물'],
            '2023-11-24': ['유부잔치국수', '김치메밀전병', '탕평채', '무들깨나물', '포기김치/단무지무침']
        }
        data.additional = {
            '2023-11-20': ['돈까스정식'],
            '2023-11-21': ['돈까스정식'],
