...
class ExcelCrawler:
    ...
    def __init__(self, driver_path):
        ...
        self.__driver = webdriver.Chrome(executable_path=driver_path, options=options)
    ...
    def getFile(self):
        ...
        self.__driver.close()
        self.__driver.quit()
        self.__rename_last_downloaded_file()
    ...
    def __rename_last_downloaded_file(self):
        ...
        new_path_name = latest_file.replace(filename, time.strftime('%Y%m%d', time.localtime()))
